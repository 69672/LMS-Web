	...
	<section>
			...
			<div class="box1" style="margin-left: 400px; margin-top:10px; height:500px;">
				...
				<p style="padding-left: 45px; color=white;">
					<br><br>
					<a style="color: yellow; text-decoration: none;" href="update_password.php">Forgot Passowrd?</a>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  
		 ...
		 if(isset($_POST['submit']))
		 {
		 	...
		 	if($count==0)
		 	{
		 		?>
		 			...
		 			<div class="alert alert-danger" style="width:400px; margin-left:320px; margin-top:100px; color: rgba(254, 254, 254, 1); background-color: rgba(254, 59, 59, 1);">
