...
<body><!--_______________________________sidenav_________________________________________-->
...
<br/>
  ...
  <a href="request.php" style="font-size:20px;">Book Requests</a>
  ...
  document.body.style.backgroundColor = "white";
	...
	<div class="srch">
		<form class="navbar-form" method="post" name="form1">
				...
				<input class="form-control" type="text" name="search" placeholder="Search books by name.." required="">
	...
	<div class="srch">
		<form class="navbar-form" method="post" name="form1">
				...
				<button style="background-color: lightblue;" type="submit" name="submit1" class="btn btn-default">
					Request
	...
	<?php
		...
		if(isset($_POST['submit1']))
		{
			if(isset($_SESSION['login_user']))
			{
				...
				mysqli_query($db,"INSERT INTO booklog (Username, bID) VALUES ('$_SESSION[login_user]', '$_POST[bid]')");
